...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Figtree:ital,wght@0,400..700;1,400..700&family=Geist:wght@400..700&family=Fraunces:ital,wght@0,500;0,600;1,500&display=swap",
      },
    ],
  }),
  component: Root,
