...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CXYIgNK9.mjs");
...
var manifest = { "332b9b5ce4684d975fbeea4c3c21b16d9906be4cfd882c2c56bbe08063d3bcb5": {
	functionName: "generateStudySet_createServerFn_handler",
	importer: () => import("./generate-set-DFauqMDu.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DG_-w2tf.mjs").then((n) => n.t),
