import { a as isDynamicBaseURLConfig, c as wildcardMatch, i as getProtocol, n as getHost, o as isRequestLike, r as getOrigin, s as resolveBaseURL, t as getBaseURL } from "./url-Dj5TGTcl.js";
...
import { defineRequestState, getBetterAuthVersion, getCurrentAdapter, getCurrentAuthEndpointContext, hasRequestState, queueAfterTransactionHook, runWithAdapter, runWithEndpointContext, runWithRequestState, runWithTransaction, tryGetCurrentAuthEndpointContext } from "@better-auth/core/context";
...
import { additionalAuthorizationParamsSchema, applyDefaultAccessTokenExpiry, createAuthorizationURL, mergeScopes, refreshAccessToken, supportsIdTokenSignIn, validateAuthorizationCode, verifyProviderIdToken } from "@better-auth/core/oauth2";
...
var cookieCachePayloadSchema = z$1.looseObject({
	session: sessionSchema.loose(),
	user: userSchema.loose(),
	updatedAt: z$1.number(),
	version: z$1.string().optional()
});
var compactCookieCacheSchema = z$1.object({
	session: z$1.record(z$1.string(), z$1.unknown()),
...
var stateDataSchema = z$1.looseObject({
	...
	*/
	idTokenNonce: z$1.string().optional(),
	/**
	...
	*/
	serverContext: z$1.record(z$1.string(), z$1.unknown()).optional()
});
...
var unlinkAccount = createAuthEndpoint("/unlink-account", {
	method: "POST",
	body: z$1.object({ accountId: z$1.string().meta({ description: "The Better Auth account ID to unlink" }) }),
	use: [freshSessionMiddleware],
	metadata: { openapi: {
...
var accountSelectionSchema = z$1.union([z$1.strictObject({
	accountId: z$1.string().meta({ description: "The Better Auth account ID" }),
	userId: z$1.string().meta({ description: "The user ID associated with the account" }).optional()
}), z$1.strictObject({
	useAccountCookie: z$1.literal(true).meta({ description: "Select the current OAuth account from its signed cookie" }),
	userId: z$1.string().meta({ description: "The user ID associated with the account" }).optional()
})]);
...
var signOutBodySchema = z$1.object({
	callbackURL: z$1.string().meta({ description: "The URL to redirect to after provider logout" }).optional(),
	disableRedirect: z$1.boolean().meta({ description: "Return the provider logout URL without redirecting" }).optional(),
	state: z$1.string().meta({ description: "State to pass to the provider logout endpoint" }).optional()
}).optional();
