...
import { u as useStudyStore } from "./router-BFTGDrgj.js";
...
import { n as masteryPercent } from "./quiz-5wHUEHYV.js";
import { t as Badge } from "./badge-v77uc72S.js";
import { t as Progress } from "./progress-B8kZuhj5.js";
...
//#region src/components/set-card.tsx
	...
	return /* @__PURE__ */ jsxs(Link, {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Badge, { children: set.subject }), /* @__PURE__ */ jsxs("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: "İlerleme" }), /* @__PURE__ */ jsxs("span", {
						className: "tabular-nums",
						children: [mastery, "%"]
					})]
				}), /* @__PURE__ */ jsx(Progress, { value: mastery })]
			}),
			/* @__PURE__ */ jsx("p", {
...
function Home() {
	...
	const [subject, setSubject] = useState("Hepsi");
	...
	return /* @__PURE__ */ jsxs(AppShell, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("p", {
					...
					children: "Kart çevir, öğren, test et, eşleştir. Setlerin tüm cihazlarında senkronize."
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Button, {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							to: "/create",
							children: [/* @__PURE__ */ jsx(Plus, {}), "Yeni set"]
						})
					}), /* @__PURE__ */ jsx(Button, {
						asChild: true,
						variant: "outline",
						children: /* @__PURE__ */ jsxs(Link, {
							to: "/create",
							search: { ai: true },
							children: [/* @__PURE__ */ jsx(Sparkles, {}), "Konudan oluştur"]
						})
					})]
				})
			]
		}),
		continueSet ? /* @__PURE__ */ jsxs(Link, {
			to: "/sets/$setId",
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("h2", {
				...
				children: [/* @__PURE__ */ jsx(Search, { className: "pointer-events-none absolute top-1/2 left-3 size-4 -translate-y-1/2 text-subtle" }), /* @__PURE__ */ jsx(Input, {
					value: query,
		...
		filtered.length === 0 ? /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(EmptyState, {
				...
				action: sets.length === 0 ? /* @__PURE__ */ jsxs("div", {
			...
			children: filtered.map((set) => /* @__PURE__ */ jsx(SetCard, { set }, set.id))
		})
	] });
}
//#endregion
