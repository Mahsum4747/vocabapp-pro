...
import { t as require_browser_external_fs } from "./browser-external_fs-KkdhSMg4.js";
import { t as require_browser_external_stream } from "./browser-external_stream-IblBMSOn.js";
import { i as require_browser_external_events, n as require_browser_external_buffer, r as require_browser_external_crypto, t as require_safe_buffer } from "./safe-buffer-esV4y3JN.js";
import { t as require_browser_external_util } from "./browser-external_util-Caz4adCg.js";
import { t as require_browser_external_path } from "./browser-external_path-C2Hp-KAu.js";
...
var require_util$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = { pkg: require_package$3() };
}));
//#endregion
...
var require_gaxios$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var randomUUID = async () => globalThis.crypto?.randomUUID() || (await import("./safe-buffer-esV4y3JN.js").then((n) => /* @__PURE__ */ __toESM(n.r()))).randomUUID();
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-B2BaNlkP.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-CNjJGDuj.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
...
var require_gaxios = /* @__PURE__ */ __commonJSMin(((exports) => {
 ...
 /**
		...
		*/
		...
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-Cy_X2AB_.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
...
var require_gcp_residency = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var os_1 = require_browser_external_os();
	/**
...
//#endregion
//#region browser-external:process
var require_browser_external_process = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "process" has been externalized for browser compatibility. Cannot access "process.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_logging_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var process = __importStar(require_browser_external_process());
	var util = __importStar(require_browser_external_util());
...
nodeEnables: "GOOGLE_SDK_NODE_LOGGING" };
	...
	*/
	function log(namespace, parent) {
		if (!cachedBackend) {
			if (!process.env[exports.env.nodeEnables]) return exports.placeholder;
		}
	...
	var CredentialsProviderFactory = class {
		...
		*/
		static create(keyFilePath) {
			switch (path.extname(keyFilePath)) {
	...
	var CertificateSubjectTokenSupplier = class {
		...
		*/
		async #processChainFromPaths(leafCertBuffer) {
			...
			try {
				const chainCerts = ((await fs.promises.readFile(this.trustChainPath, "utf8")).match(/-----BEGIN CERTIFICATE-----[^-]+-----END CERTIFICATE-----/g) ?? []).map((pem, index) => {
					try {
	...
	exports.PluggableAuthHandler = class PluggableAuthHandler {
		...
		*/
		async retrieveCachedResponse() {
			...
			if (!(await fs.promises.lstat(filePath)).isFile()) return;
			const responseString = await fs.promises.readFile(filePath, { encoding: "utf8" });
...
var require_googleauth = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var child_process_1 = require_browser_external_child_process();
	var fs = require_browser_external_fs();
	var gaxios_1 = require_src$4();
	var gcpMetadata = require_src$1();
	var os = require_browser_external_os();
...
var require_credential_internal = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var fs = require_browser_external_fs();
	var node_crypto_1 = require_browser_external_node_crypto();
...
//#endregion
export { require_browser_external_child_process as _, require_validator as a, require_ecdsa_sig_formatter as c, require_src$1 as d, require_src$2 as f, require_extend as g, require_browser_external_https as h, require_credential_internal as i, require_browser_external_querystring as l, require_browser_external_os as m, require_fast_deep_equal as n, require_error$1 as o, require_browser_external_process as p, require_utils as r, require_jws as s, require_app as t, require_base64_js as u };
